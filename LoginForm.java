...
public class LoginForm extends javax.swing.JFrame {
    ...
    /**
     * Constructor Creates new form LoginForm
     */
    public LoginForm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Punchr Login Form");
    ...
    private void jButton_LOGINActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LOGINActionPerformed
        ...
        try 
        {
            ...
            if(rs.next())
            {
                HOME_Staff_JFrame mf = new HOME_Staff_JFrame();
                mf.setVisible(true);
                mf.pack();
                mf.setLocationRelativeTo(null);
                //mf.setExtendedState(JFrame.MAXIMIZED_BOTH);
                mf.jLabel_Welcome.setText("Hi "+username+"!");
        ...
        if (!done)
        {
            try 
            {
                ...
                if(rs.next())
                {
                    ...
                    mf.setLocationRelativeTo(null);
                    //mf.setExtendedState(JFrame.MAXIMIZED_BOTH);
                    mf.jLabel_Welcome.setText("Punch Code: "+rs.getString("punchcode"));
                    mf.jLabelHidden.setText(rs.getString("punchcode"));
                    mf.PunchCount.setText(String.valueOf(rs.getInt("punchcount")));
